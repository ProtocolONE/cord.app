...
#ifndef EXECUTORBRIDGEADAPTOR_H_1411119977
#define EXECUTORBRIDGEADAPTOR_H_1411119977
...
public Q_SLOTS: // METHODS
    ...
    void execute(const QString &serviceId, GameNet::Host::Bridge::Credential credential);
    void executeSecond(const QString &serviceId, GameNet::Host::Bridge::Credential credential, GameNet::Host::Bridge::Credential secondCredential);
