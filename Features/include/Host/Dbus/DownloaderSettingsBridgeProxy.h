...
#ifndef DOWNLOADERSETTINGSBRIDGEPROXY_H_1409819876
#define DOWNLOADERSETTINGSBRIDGEPROXY_H_1409819876
...
/*
 * Proxy class for interface com.gamenet.dbus.DownloaderSettings
 */
...
public:
    ...
    { return "com.gamenet.dbus.DownloaderSettings"; }

public:
    DownloaderSettingsBridgeProxy(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
