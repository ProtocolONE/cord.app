...
#ifndef APPLICATIONBRIDGEPROXY_H_1424862459
#define APPLICATIONBRIDGEPROXY_H_1424862459
...
public Q_SLOTS: // METHODS
    inline QDBusPendingReply<> cancelUninstallServiceRequest(const QString &serviceId)
    {
        ...
        return asyncCallWithArgumentList(QLatin1String("cancelUninstallServiceRequest"), argumentList);
    }
