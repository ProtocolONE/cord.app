...
class SettingsViewModel : public QObject
{
    ...
    Q_PROPERTY(bool notifyWhenStartedProtocolOne READ notifyWhenStartedProtocolOne WRITE setNotifyWhenStartedProtocolOne NOTIFY notifyWhenStartedProtocolOneChanged)
...
public slots:
    ...
    bool notifyWhenStartedProtocolOne();
    void setNotifyWhenStartedProtocolOne(bool _notify);
...
signals:
    ...
    void notifyWhenStartedProtocolOneChanged();
