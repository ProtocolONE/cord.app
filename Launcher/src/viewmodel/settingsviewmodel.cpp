...
bool SettingsViewModel::notifyWhenStartedProtocolOne()
{
  P1::Settings::Settings settings;
  return settings.value("Launcher/notifyWhenStartedProtocolOne").toBool();
}

void SettingsViewModel::setNotifyWhenStartedProtocolOne(bool _notify)
{
  bool tmp = this->notifyWhenStartedProtocolOne();
  if (tmp == _notify)
    return;
...
{
  P1::Settings::Settings settings;
  return settings.value("launcher/notifyStartEndGameDownload").toBool();
}
...
{
  P1::Settings::Settings settings;
  return settings.value("launcher/notifyDisconnectFriendFromNetwork").toBool();
}
...
{
  P1::Settings::Settings settings;
  return settings.value("launcher/notifyDisconnectFriendFromGame").toBool();
}
...
{
  P1::Settings::Settings settings;
  return settings.value("launcher/notifyNewMessage").toBool();
}
...
void SettingsViewModel::setDefaultSettings()
{
  ...
  setNotifyWhenStartedProtocolOne(false);
