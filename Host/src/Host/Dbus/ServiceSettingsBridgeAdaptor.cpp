...
int ServiceSettingsBridgeAdaptor::gameSize(const QString &serviceId)
{
    // handle method call com.gamenet.dbus.ServiceSettings.gameSize
    int out0;
    QMetaObject::invokeMethod(parent(), "gameSize", Q_RETURN_ARG(int, out0), Q_ARG(QString, serviceId));
    return out0;
}
